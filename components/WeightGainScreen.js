  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.box}>
        <Text style={styles.text}>WeightGain Diet</Text></View>
      ...
      <Text style={styles.text1}>MEAL 1-BULK SHAKE</Text>
      ...
      <Text style={styles.text1}>MEAL 4-BULK SHAKE(same as meal 1)</Text>
      <View style={styles.row}>
        <View style={styles.cell}>
          <Text style={styles.header}>INGREDIENTS</Text>
        </View>
